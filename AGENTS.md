...
- **Repository:** liads/ha-climate-zh-jt-03

**Key directories:**

- `custom_components/climate_ir_zhjt03/` - Main integration code
...
- Integration logs: `custom_components.climate_ir_zhjt03: debug` in `config/configuration.yaml`
...
- Use the domain `climate_ir_zhjt03` for all DOMAIN references
- Prefix all integration-specific classes with `ClimateZHJT03`
- Use "Climate for IR Devices using ZH/JT-03 Remote" as the display title
...
- Inherit from platform base + `ClimateZHJT03Entity`
...
- `tests/` mirrors `custom_components/climate_ir_zhjt03/` structure
