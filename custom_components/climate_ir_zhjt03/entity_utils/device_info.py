"""Device info utilities for climate_ir_zhjt03."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Climate for IR Devices using ZH/JT-03 Remote",
        manufacturer=manufacturer or "Climate for IR Devices using ZH/JT-03 Remote",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('climate_ir_zhjt03', 'entry_id_value')}
    """
