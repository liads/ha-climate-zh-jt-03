"""
Options flow for climate_ir_zhjt03.
...
from custom_components.climate_ir_zhjt03.config_flow_handler.schemas import get_options_schema
from homeassistant import config_entries


class ClimateZHJT03OptionsFlow(config_entries.OptionsFlow):
    """
...
__all__ = ["ClimateZHJT03OptionsFlow"]
