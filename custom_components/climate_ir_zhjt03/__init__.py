"""
Custom integration to integrate climate_ir_zhjt03 with Home Assistant.
...
https://github.com/liads/ha-climate-zh-jt-03
...
from .data import ClimateZHJT03Data
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import ClimateZHJT03ConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = ClimateZHJT03Data(
        client=client,
