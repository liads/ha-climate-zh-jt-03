"""
Base entity class for climate_ir_zhjt03.
...
from custom_components.climate_ir_zhjt03.const import ATTRIBUTION
...
class ClimateZHJT03Entity(CoordinatorEntity[ClimateZHJT03DataUpdateCoordinator]):
    """
    Base entity class for climate_ir_zhjt03.
