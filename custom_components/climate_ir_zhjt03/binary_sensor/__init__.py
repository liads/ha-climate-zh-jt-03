"""Binary sensor platform for climate_ir_zhjt03."""
...
from .connectivity import ENTITY_DESCRIPTIONS as CONNECTIVITY_DESCRIPTIONS, ClimateZHJT03ConnectivitySensor
from .filter import ENTITY_DESCRIPTIONS as FILTER_DESCRIPTIONS, ClimateZHJT03FilterSensor
...
async def async_setup_entry(
    ...
    connectivity_entities = [
        ClimateZHJT03ConnectivitySensor(
