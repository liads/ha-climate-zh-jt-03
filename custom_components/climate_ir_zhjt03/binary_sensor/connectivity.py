"""Connectivity binary sensor for climate_ir_zhjt03."""
...
class ClimateZHJT03ConnectivitySensor(BinarySensorEntity, ClimateZHJT03Entity):
    """Connectivity sensor for climate_ir_zhjt03."""
