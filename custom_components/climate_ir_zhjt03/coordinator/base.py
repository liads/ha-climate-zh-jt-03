"""
Core DataUpdateCoordinator implementation for climate_ir_zhjt03.
...
from custom_components.climate_ir_zhjt03.api import (
    ClimateZHJT03ApiClientAuthenticationError,
    ClimateZHJT03ApiClientError,
)
from custom_components.climate_ir_zhjt03.const import LOGGER
...
class ClimateZHJT03DataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: ClimateZHJT03ConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except ClimateZHJT03ApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="climate_ir_zhjt03",
                translation_key="authentication_failed",
            ) from exception
        except ClimateZHJT03ApiClientError as exception:
