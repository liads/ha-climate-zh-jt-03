"""
API Client for climate_ir_zhjt03.
...
class ClimateZHJT03ApiClientError(Exception):
    """Base exception to indicate a general API error."""


class ClimateZHJT03ApiClientCommunicationError(
    ClimateZHJT03ApiClientError,
):
    """Exception to indicate a communication error with the API."""


class ClimateZHJT03ApiClientAuthenticationError(
    ClimateZHJT03ApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        ClimateZHJT03ApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise ClimateZHJT03ApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class ClimateZHJT03ApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            ClimateZHJT03ApiClientAuthenticationError: If authentication fails.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise ClimateZHJT03ApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise ClimateZHJT03ApiClientError(
                msg,
            ) from exception
