...
- **`entity/`** - Base entity classes (inherit `ClimateZHJT03Entity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, ClimateZHJT03Entity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import ClimateZHJT03Entity`
