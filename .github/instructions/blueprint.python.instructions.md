...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `ClimateZHJT03`
...
- Inherit from both platform entity and `ClimateZHJT03Entity` (order matters)
...
from custom_components.climate_ir_zhjt03.sensor import async_setup_entry
...
**Config entry data:** `entry_data: ClimateZHJT03Data = hass.data[DOMAIN][entry.entry_id]`
