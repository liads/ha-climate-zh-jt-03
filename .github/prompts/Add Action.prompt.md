...
**File:** `custom_components/climate_ir_zhjt03/services.yaml`
...
Create `custom_components/climate_ir_zhjt03/service_actions/[action_name].py`:

```python
"""[Action name] service action for Climate for IR Devices using ZH/JT-03 Remote."""
...
**File:** `custom_components/climate_ir_zhjt03/__init__.py`
...
**File:** `custom_components/climate_ir_zhjt03/const.py`
...
3. Find service action: `climate_ir_zhjt03.[action_name]`
...
- **Service actions directory:** `custom_components/climate_ir_zhjt03/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/climate_ir_zhjt03/services.yaml` (legacy filename)
- **Icons:** `custom_components/climate_ir_zhjt03/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/climate_ir_zhjt03/translations/*.json` under `services` key (legacy)
