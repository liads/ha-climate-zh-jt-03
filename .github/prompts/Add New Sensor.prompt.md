...
- Create new sensor file in `custom_components/climate_ir_zhjt03/sensor/`
- Inherit from `ClimateZHJT03Entity` and `SensorEntity`
...
```python
"""[Sensor description] for Climate for IR Devices using ZH/JT-03 Remote."""
...
class ClimateZHJT03[SensorName]Sensor(
    ClimateZHJT03Entity,
    SensorEntity,
):
...
- Entity: `custom_components/climate_ir_zhjt03/sensor/[sensor_name].py`
- Platform: `custom_components/climate_ir_zhjt03/sensor/__init__.py`
- Translations: `custom_components/climate_ir_zhjt03/translations/*.json`
