...
- Inherit from `ClimateZHJT03Entity` and platform base class
...
- Entity: `custom_components/climate_ir_zhjt03/[platform]/[entity_name].py`
- Platform: `custom_components/climate_ir_zhjt03/[platform]/__init__.py`
