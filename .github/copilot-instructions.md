...
- **Main code:** `custom_components/climate_ir_zhjt03/`
...
- `entity/` — Base entity class (`ClimateZHJT03Entity`)
...
- Entity MRO: `(PlatformEntity, ClimateZHJT03Entity)` — order matters
...
- Debug level: `custom_components.climate_ir_zhjt03: debug` in `config/configuration.yaml`
